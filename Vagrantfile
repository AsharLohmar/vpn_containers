...
SHELL
  ...
  #config.vm.synced_folder "/mnt/d/work/repos/docker_vpn/docker", "/vpn", create: true, mount_options: ["umask=22", "fmask=11"], automount: true
